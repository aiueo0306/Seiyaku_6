...
# ===== 固定情報（学会サイト） =====
BASE_URL = "https://www.ferring.co.jp/media/press-releases/"
GAKKAI = "フェリングファーマ"

SELECTOR_TITLE = "section.row div.blog-details-inner"
title_selector = "h3"
title_index = 0
href_selector = "a"
href_index = 0
SELECTOR_DATE = "section.row div.blog-details-inner"  # typo修正済み
date_selector = "time"
date_index = 0
year_unit = ""
month_unit = " "
day_unit = " "
date_format = "%d %B %Y"  # フォールバック用に残すだけでもOK
date_regex  = r"(\d{1,2})\s+([A-Za-z]{3,9})\s+(\d{4})"
