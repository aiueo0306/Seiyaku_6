...
# ===== 固定情報（学会サイト） =====
BASE_URL = "https://www.biogen.co.jp/news.html"
GAKKAI = "バイオジェン"

SELECTOR_TITLE = "div.flex-wrap.cmp-tile-list-wrap div.card-body"
title_selector = "a"
title_index = 0
href_selector = "a"
href_index = 0
SELECTOR_DATE = "div.news-date"
date_selector = ""
date_index = 0
year_unit = "年"
month_unit = "月"
...
POPUP_BUTTONS = ["全て許可","はい"]  # 必要に応じて編集
