...
# ===== 固定情報（学会サイト） =====
BASE_URL = "https://www.pfizer.co.jp/pfizer/company/press"
GAKKAI = "ファイザー"

SELECTOR_TITLE = "corporate-link-with-date.hydrated"
title_selector = "helix-core-heading.helix-core-heading.hydrated"
title_index = 0
href_selector = "a"
href_index = 0
SELECTOR_DATE = "helix-core-content.cdp-corp-body-copy-s.helix-core-content.hydrated"  # typo修正済み
date_selector = ""
date_index = 0
year_unit = "/"
month_unit = "/"
