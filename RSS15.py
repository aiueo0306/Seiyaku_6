...
# ===== 固定情報（学会サイト） =====
BASE_URL = "https://www.fujichemical.co.jp/news/index.html"
GAKKAI = "富士化学"

SELECTOR_TITLE = "div#NEWS_list div.news_block"
title_selector = "a"
title_index = 0
href_selector = "a"
href_index = 0
SELECTOR_DATE = "div#NEWS_list div.news_block"  # typo修正済み
date_selector = "div.tp_news_date"
date_index = 0
year_unit  = " "          # 末尾空白は任意
month_unit = "/"      # 「6月」「6 月」どちらもOK
day_unit   = ""      # 「,」「, 」「 , 」等OK
...
POPUP_BUTTONS = ["はい。報道関係者です。"] if POPUP_MODE else [] 
