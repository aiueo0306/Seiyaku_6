...
# ===== 固定情報（学会サイト） =====
BASE_URL = "https://www.novartis.com/jp-ja/news/news-archive?type=news"
GAKKAI = "ノバルティス（ニュース）"

SELECTOR_TITLE = "div.item-list"
title_selector = "span.field-content"
title_index = 2
href_selector = "a"
href_index = 0
SELECTOR_DATE = "div.item-list"
date_selector = "h2"
date_index = 0
...
# 正規表現（英語月名 + 日 + , + 年）
date_regex = r"(?:([A-Za-z]{3})\s+(\d{1,2}),\s+(\d{4})|(\d{1,2})月\s+(\d{4}))"
