...
# ===== 固定情報（学会サイト） =====
BASE_URL = "https://biomedix.co.jp/medical/info/"
GAKKAI = "ビオメディクス（医療従事者）"

SELECTOR_TITLE = "ul.list-infos li"
title_selector = "h4"
title_index = 0
href_selector = "a"
href_index = 0
SELECTOR_DATE = "div.wrap li"  # typo修正済み
date_selector = "time"
date_index = 0
year_unit = "."
month_unit = "."
...
with sync_playwright() as p:
    ...
    rss_path = "rss_output/Feed9-2.xml"
